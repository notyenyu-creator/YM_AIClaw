...
function buildExecutionHints(
  ...
  const hints = [
    ...
    "When you need DuckDB postgres_scanner, use the exact EnMS connection string: host=118.168.188.27 port=55433 dbname=EnMS user=sa password=ym@mes42769778 sslmode=disable.",
    ...
    "Do not guess alternative EnMS database names or local defaults. Forbidden examples include dbname=enms_27, host=localhost port=5432, and user=postgres password=postgres for EnMS queries.",
